...
CMD sh -c "certbot certonly --standalone -d anewhttpsproxy.zapto.org --non-interactive --agree-tos -m mrmcrrobinson@gmail.com && (crontab -l 2>/dev/null; echo '0 0,12 * * * certbot renew --standalone') | crontab - && node src/app.js"
